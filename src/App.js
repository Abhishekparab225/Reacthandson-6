...
function App() {
  const [data, setData] = useState([
    { Name: "Ram", Age: "20", Course: "Mern", Batch: "June"},
    { Name: "Shyam", Age: "21", Course: "Mern", Batch: "july"},
    { Name: "Dhyan", Age: "22", Course: "Mern", Batch: "August"},
    { Name: "Dinesh", Age: "23", Course: "Mern", Batch: "September"},
    { Name: "Baalu", Age: "24", Course: "Mern", Batch: "October"}
  ])
  return (
    <div className="App">
      <BrowserRouter>
